...
class App(tk.Tk):
    def __init__(self):
        ...
        #Program Version
        self.program_version = 'build alfa0.01'
    ...
    def main_main_window(self):
        ...
        def change_music_state():
            if self.music_preset.get() == False:
                self.main_music_info_btn.configure(text = 'Blocked', command = '')
            elif self.music_preset.get() == True:
                self.main_music_info_btn.configure(text = 'Explore', command = lambda: tk.messagebox.showwarning("WARNING", "This Session is on Development"))
        ...
        self.menu.add_command(label='Extract Original Charts', command = self.extract_charts)
        ...
        self.main_config_frame.grid(row = 1, column = 0, sticky = tk.W, pady=(195, 0))
        ...
        self.main_config_checkbutton2.grid(row = 2, column = 0, sticky = tk.W, pady = (0, 5))

        self.main_config_text = tk.Label(
            self.main_config_frame, text = '(▲ if this box is not checked,\nthe program will generate the\nfiles, but the generation\nof the .ISO will be up to you.) ', font = ('Arial', 9), justify=tk.LEFT
        )
        self.main_config_text.grid(row = 3, column = 0, sticky = tk.W)
        ...
        self.main_music_info_radio1 = ttk.Radiobutton(
            ...
            variable = self.music_preset, command = change_music_state
        )
        ...
        self.main_music_info_btn = ttk.Button(
            self.main_music_info_frame, text = 'Blocked'
        )
        ...
        self.main_main_button_version.grid(row = 1, column = 0, columnspan = 3, pady = (20, 0))
    ...
    def information_menu(self):
        ...
        self.menu_toplevel.title('minibuildergh3 - information')
        self.menu_toplevel.resizable(False, False)
        ...
        self.menu_text.grid(row = 1, column = 0, columnspan = 3, pady = (10, 35))
